...
@Component({
  selector: 'app-garment-discounted-detail',
  templateUrl: './garment-discounted-detail.component.html',
  styleUrls: ['./garment-discounted-detail.component.scss']
})
export class GarmentDiscountedDetailComponent {
  ...
  constructor(
    ...
    this.activatedRoute.params.subscribe((params) => {
      ...
      this.discountedProductsService.getDiscountedProductsDetail(garmentId).subscribe((garment) => {
        this.discountedProduct = garment;
      })
    });
  }
  ...
  public backToList(){
    this.router.navigate(['home/garment-discounted-list'])
  }
